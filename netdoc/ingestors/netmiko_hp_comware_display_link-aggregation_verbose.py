...
def ingest(log, force=False):
    ...
    for item in log.parsed_output:
        # Parsing
        # https://github.com/dainok/ntc-templates/blob/hpe-templates/tests/hp_comware/display_link-aggregation_verbose/hp_comware_display_link-aggregation_verbose.yml
        device_o = log.discoverable.device
        bundle_name = item['interface']
        physical_interfaces = item['local_interfaces']
